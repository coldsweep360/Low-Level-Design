...
public class DecoratorExample {
    ...
    abstract static class Topping implements Pizza {
        final Pizza base;
    ...
    static class Cheese extends Topping {
        Cheese(Pizza base) {
            super(base);
        }
    ...
    static class Olives extends Topping {
        ...
        public String description() {
            return base.description() + "+ olives";
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(order.description() + ": Rs " + order.cost());
    }
}

...
public class VisitorExample {
    interface Product {
        int accept(TaxVisitor visitor);
    }

    static class Book implements Product {
        public int accept(TaxVisitor visitor) {
    ...
    static class IndiaTax implements TaxVisitor {
    ...
    public static void main(String[] args) {
        TaxVisitor tax = new IndiaTax();
        System.out.println("Book tax: " + new Book().accept(tax));
        System.out.println("Food tax: " + new Food().accept(tax));
    }
}

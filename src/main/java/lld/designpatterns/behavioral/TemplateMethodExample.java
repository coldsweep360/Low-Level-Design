...
public class TemplateMethodExample {
    static abstract class HotDrink {
        ...
        abstract void brew(); abstract void addExtras();
        private void pour() { System.out.println("Pour into cup"); }
    }
    static class Tea extends HotDrink { void brew() { System.out.println("Steep tea"); } void addExtras() { System.out.println("Add lemon"); } }
    public static void main(String[] args) { new Tea().prepare(); }
}
